...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LCTL_T(KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                            KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, HYPR_T(KC_QUOT),
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                            KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                            KC_LGUI, KC_LALT, TD(TD_LWR), MO(_RAISE), KC_SPC,  KC_ENT
    ),
    ...
    [_LOWER] = LAYOUT_split_3x6_3(
        KC_GRV,  _______, KC_VOLD, KC_VOLU, KC_MPLY, KC_MNXT,                         _______, _______, _______, KC_MINS, KC_EQL,  _______,
    ...
    // function layer for F1..F12 keys and caps lock, as well as keyboard functions like Windows/Mac mode and n-key rollover mode
    [_ADJUST] = LAYOUT_split_3x6_3(
        _______, KC_F11,  KC_F12,  _______, _______, _______,                         _______, _______, _______, _______, _______, KC_SPAM_BSPC,
        KC_CAPS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                           KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  LCTL(LALT(KC_DEL)),
        _______, _______, _______, _______, AG_LNRM, AG_LSWP,                         NK_OFF,  NK_ON,   _______, _______, _______, _______,
                                            _______, _______, _______,       _______, _______, _______
    )
};
