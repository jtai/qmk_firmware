...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LCTL_T(KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                            KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, HYPR_T(KC_QUOT),
    ...
    [_ADJUST] = LAYOUT_split_3x6_3(
        ...
        KC_CAPS, KC_F11,  KC_F12,  _______, _______, _______,                         _______, _______, _______, _______, _______, LCTL(LALT(KC_DEL)),
        _______, _______, DF(_QWERTY), DF(_COLEMAK), _______, QK_BOOT,                NK_TOGG, _______, _______, _______, _______, _______,
                                            _______, _______, _______,       _______, _______, _______
    )
};
