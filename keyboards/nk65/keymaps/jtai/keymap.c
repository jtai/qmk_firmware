...
[1] = LAYOUT_65_ansi( /* Missing keys, Media keys, Extra arrow keys */
    ...
    KC_TRNS, KC_TRNS, LALT(KC_W), KC_MNXT, KC_MPLY, LALT(KC_T), KC_TRNS, KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PSCR,\
    KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS,          KC_TRNS, KC_SLCK,\
